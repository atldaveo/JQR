...
test_divide(void) 
{
    ...
    CU_ASSERT(1 == res);
    CU_ASSERT_EQUAL(divide(3, 2, &res), -1);                      /**< False assertion */
    CU_ASSERT_FALSE(15 == res);
...
test_shift_right(void)
{
    ...
    CU_ASSERT_EQUAL(shift_right(0x80000000, 0, &res), 0);
    CU_ASSERT(0x80000000 == res);
    CU_ASSERT_EQUAL(shift_right(0x80000000, 1, &res), 0);
    CU_ASSERT(0x40000000 == res);
    CU_ASSERT_EQUAL(shift_right(0x80000000, 31, &res), 0);
    CU_ASSERT(1 == res);
    CU_ASSERT_EQUAL(shift_right(0xFFFFFFFF, 1, &res), 0);
    CU_ASSERT(0x7FFFFFFF == res);
    CU_ASSERT_EQUAL(shift_right(1, 1, &res), 0);
    CU_ASSERT(0 == res);
}
...
test_shift_left(void)
{
    ...
    CU_ASSERT_EQUAL(shift_left(1, 0, &res), 0);
    CU_ASSERT(1 == res);
    CU_ASSERT_EQUAL(shift_left(1, 1, &res), 0);
    CU_ASSERT(2 == res);
    CU_ASSERT_EQUAL(shift_left(1, 31, &res), 0);
    CU_ASSERT(0x80000000 == res);
    CU_ASSERT_EQUAL(shift_left(0xFFFFFFFF, 1, &res), 0);
    CU_ASSERT(0xFFFFFFFE == res);
    CU_ASSERT_EQUAL(shift_left(0x80000000, 1, &res), 0);
    CU_ASSERT(0 == res);
}
